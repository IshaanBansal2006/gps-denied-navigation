"""
TCN v6: more data — added V1_03_difficult to train split.

Hypothesis: V1_03_difficult is a challenging vicon-room sequence; adding it
expands training diversity without changing model or loss.

Changes from v3:
  - TRAIN_SEQS includes "V1_03_difficult" (6385 total windows, up from 5548)
  - Everything else identical to v3: [16,32,32] model, directional loss alpha=0.6,
    balanced sampler, batch_size=64, lr=3e-4, cosine schedule, patience=25

Saves:
  checkpoints/tcn_v6.pt
  results/tcn_v6/{loss_history,test_metrics}.json
"""
...
RESULTS_DIR = PROJECT_ROOT / "results" / "tcn_v6"
...
def main() -> None:
    ...
    no_improve = 0
    patience = 25
    best_ckpt = CHECKPOINT_DIR / "tcn_v6.pt"
